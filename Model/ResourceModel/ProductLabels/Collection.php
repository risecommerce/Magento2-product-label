...
namespace Risecommerce\ProductLabel\Model\ResourceModel\ProductLabels;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Risecommerce\ProductLabel\Model\ProductLabels::class,
            \Risecommerce\ProductLabel\Model\ResourceModel\ProductLabels::class
        );
    }
    ...
    public function addStoreFilter($tabId)
    {
        ...
        $this->setMainTable('risecommerce_product_label_rules_store');
    ...
    {
        $this->getSelect()->reset(\Magento\Framework\DB\Select::WHERE);
        $this->setMainTable('risecommerce_product_label_rules_customer_group');
    ...
    public function _afterLoad()
    {
        ...
        if (count($linkedIds)) {
            $this->addData($this->getTable('risecommerce_product_label_rules_store'), 'store_id', $linkedIds, $linkField);
            $this->addData($this->getTable('risecommerce_product_label_rules_customer_group'), 'customer_group_id', $linkedIds, $linkField);
        }
