<?php
namespace Risecommerce\ProductLabel\Model\Product\Attribute\Backend;
...
class File extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    {
        if ($this->request->getModuleName() != 'risecommerce_product_label') {
            $path = $this->_filesystem->getDirectoryRead(
                DirectoryList::MEDIA
            )->getAbsolutePath(
                'risecommerce/product_label_image/'
            );
