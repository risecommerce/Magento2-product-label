...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('Risecommerce_ProductLabel');
     ...
     * Add Tab to Form
     *
     * @param \Risecommerce\ProductLabel\Model\ProductLabels $model
     * @param string $fieldsetId
     * @param string $formName
     * @return \Magento\Framework\Data\Form
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'risecommerce_product_label_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
